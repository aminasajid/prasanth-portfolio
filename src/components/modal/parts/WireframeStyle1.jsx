    ...
    <div className="mt-16 md:mt-20">
      ...
      <div className="md:hidden flex justify-center gap-4 mt-6">
        <button
          type="button"
          onClick={() => scrollBy(-1)}
          className="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-lg hover:bg-gray-50 active:scale-95 transition-all border border-gray-100"
          aria-label="Previous"
        >
